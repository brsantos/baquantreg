...
BayesQR <- function(tau, y, X, itNum, thin, betaValue, sigmaValue, vSampleInit, priorVar, refresh, quiet, tobit, recordLat, blocksV, stopOrdering, numOrdered) {
    .Call('_baquantreg_BayesQR', PACKAGE = 'baquantreg', tau, y, X, itNum, thin, betaValue, sigmaValue, vSampleInit, priorVar, refresh, quiet, tobit, recordLat, blocksV, stopOrdering, numOrdered)
}
