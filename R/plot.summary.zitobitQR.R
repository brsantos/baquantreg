...
#'  credible intervals.
#'
#' @param object This is an object of the class "summary.zitobitQR",
...
plot.summary.zitobitQR <- function(object, separate = FALSE, beta = TRUE,
                                   sigma = FALSE, gamma = FALSE, ...){
  if (class(object) != "summary.zitobitQR")
